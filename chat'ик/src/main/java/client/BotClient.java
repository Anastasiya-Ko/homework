...
//Чат бот, который умеет принимать запросы и отправлять данные о текущей дате и времени.
public class BotClient extends Client{
    ...
    protected boolean shouldSendTextFromConsole() {
        return false;                               //false - т.к. мы не хотим, чтобы бот отправлял текст в консоль
    }
    ...
    public class BotSocketThread extends SocketTread{
